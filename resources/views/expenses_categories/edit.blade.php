<x-layout>
    ...
    <x-card>
        <form method="POST" autocomplete="off" action="/travels/financial-expenses/categories/{{$category->id}}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-12">
                <div class="pb-12 border-b border-gray-900/10">
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-600">Edit a category.</p>
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="category" id="category"
                                        ...
                                        placeholder="f.e. Restaurants" value="{{$category->category}}">
