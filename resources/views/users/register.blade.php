...
-->
  ...
  ```
-->
        <div class="flex flex-col justify-center min-h-full px-6 py-4 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                {{-- <img class="w-auto h-10 mx-auto"
                    src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company"> --}}
                <h2 class="mt-10 text-2xl font-bold leading-9 tracking-tight text-center text-gray-900">Create new
                    account
                </h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="/users" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-keppel px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register</button>
                    </div>
                </form>
                ...
                <p class="mt-10 text-sm text-center text-gray-500">
                    ...
                    <a href="/login" class="font-semibold leading-6 text-keppel">Login</a>
